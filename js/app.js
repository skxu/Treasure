...
window.addEventListener("load",function() {
  ...
  var Q = window.Q = Quintus({ development: true })
          ...
          .setup("game", { maximize: true }).touch();
  ...
  Q.scene("level1",function(stage) {
    var player = stage.insert(new Q.Ship({ x: Q.width*2/3, y: Q.height/2}));
    var character = stage.insert(new Q.Player({x:Q.width/2 + 450, y: Q.height/2}));
    //stage.insert(new Q.Asteroid({ size: 60 }));
    //stage.insert(new Q.Asteroid({ size: 60 }));
    //stage.insert(new Q.Asteroid({ size: 60 }));
    //stage.insert(new Q.Asteroid({ size: 60 }));
    //stage.insert(new Q.Asteroid({ size: 60 }));
    var enemy = stage.insert(new Q.Enemy({ x: Q.width/2 - 100, y: Q.height/2}));
  ...
  Q.load("char.png, char.json, car.png, car.json", function() {
    Q.compileSheets("char.png", "char.json");
